...
filtered_fisheries$country_ordered <- fct_relevel(filtered_fisheries$country, 'China', 'Indonesia', 'India', 'Vietnam', 'United States', 'Russia', 'Japan', 'Philippines', 'Peru', 'Bangladesh')
...
filtered_fisheries$country_ordered <- fct_relevel(filtered_fisheries$country, 'China', 'Indonesia', 'India', 'United States', 'Russia', 'Peru', 'Japan', 'Vietnam', 'Philippines', 'Bangladesh')
...
filtered_fisheries$country_ordered <- fct_relevel(filtered_fisheries$country, 'China', 'Indonesia', 'India', 'Vietnam', 'Philippines', 'Bangladesh', 'Japan', 'United States', 'Russia', 'Peru')
